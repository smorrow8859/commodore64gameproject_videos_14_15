...
; Here we are checking the sprite as it contacts a tile moving to the left 
; (generating a collision). When a collision occurs ("sprite is flush"),
; go to subroutine @checkLeft.
