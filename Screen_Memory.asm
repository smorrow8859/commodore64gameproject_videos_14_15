...
;===============================================================================
; A helper routine to return the line address for the current front screen only. 
; A cut back version
; of FetchLineAddress for faster use with sprite/character collisions it also 
; uses the Y register
; instead of the X as that is tied up in our collision routines to hold 
; the sprite number
;
; Y = line number
...
detectScreen
        ...
        beq @screen2    
        cmp #>SCORE_SCREEN
        beq @score            ; if none of the above, it will default to Screen1
...
;===============================================================================
; NUMERICAL (HEX) DISPLAY ON SCREEN
;===============================================================================
DisplayByte
...
@writeDigit                                              
        ...
        lda #COLOR_GREEN                              ; set the color to white
...
; C64 PRG STUDIO has a lack of expression support that makes creating some 
; tables very problematic
; Be aware that you can only use ONE expression after a defined constant, 
; no braces, and be sure to account for order of precedence.

; For these tables you MUST have the Operator Calc directive set at the top of 
; your main file
; or have it checked in options or BAD THINGS WILL HAPPEN!! It basically means 
; that calculations
; will be performed BEFORE giving back the hi/lo byte with '>' rather than the 
; default of hi/lo byte THEN the calculation
SCREEN_LINE_OFFSET_TABLE_LO                                            
SCREEN1_LINE_OFFSET_TABLE_LO        
          byte <SCREEN1_MEM                      
          byte <SCREEN1_MEM + 40                 
          byte <SCREEN1_MEM + 80
          byte <SCREEN1_MEM + 120
          byte <SCREEN1_MEM + 160
          byte <SCREEN1_MEM + 200
          byte <SCREEN1_MEM + 240
          byte <SCREEN1_MEM + 280
          byte <SCREEN1_MEM + 320
          byte <SCREEN1_MEM + 360
          byte <SCREEN1_MEM + 400
          byte <SCREEN1_MEM + 440
          byte <SCREEN1_MEM + 480
          byte <SCREEN1_MEM + 520
          byte <SCREEN1_MEM + 560
          byte <SCREEN1_MEM + 600
          byte <SCREEN1_MEM + 640
          byte <SCREEN1_MEM + 680
          byte <SCREEN1_MEM + 720
          byte <SCREEN1_MEM + 760
          byte <SCREEN1_MEM + 800
          byte <SCREEN1_MEM + 840
          byte <SCREEN1_MEM + 880
          byte <SCREEN1_MEM + 920
          byte <SCREEN1_MEM + 960
